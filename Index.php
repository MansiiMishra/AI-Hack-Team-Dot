...
$aihack = $client->aihack;
$donorsignin = $aihack->donorsignin;
$receiversignin = $aihack->receiversignin;
...
if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['submitdon'])){
	...
	$result = $donorsignin->find(array('emailid'=> $emailid, 'passw'=> $passw, 'confpassw'=> $confpassw));
  
	foreach($result as $userFind) {
	  $storedEmailid = $userFind['emailid'];
	  $storedPassw = $userFind['passw'];
	  $storedConfpassw = $userFind['confpassw'];
	}
	  if(($emailid == $storedEmailid) && ($passw == $storedPassw) && ($confpassw == $storedConfpassw ) ){
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['submitrec'])){
	...
	$result = $receiversignin->find(array('emailid'=> $emailid, 'passw'=> $passw, 'confpassw'=> $confpassw));
		...
		<div class="max-width">
			...
			<div class="about-content">
				<div class="column right">
					...
					<img src="donor.png" alt="flowchart" width="300px" height="300px">
					<br>
					<!-- <p></p> -->
				...
				<div class="column right">
					...
					<img src="receiver.png" alt="flowchart" width="300px" height="300px">
					<p></p>
			...
			<div class="serv-content">
				<div class="card">
					<div class="box">
						...
						<p>Check out various rural level Businessoptions to donate for</p>
					</div>
				</div>
				<div class="card">
					<div class="box">
						...
						<p>Check out active investors that could be intereted in your plan</p>
					</div>
				</div>
				<div class="card">
					<div class="box">
						...
						<p>Check out project ideas with active donors to start your business today</p>
					</div>
				</div>
			</div>
		</div>
