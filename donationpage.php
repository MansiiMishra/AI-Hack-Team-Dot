...
$donordonation = $aihack->donordonation;
...
if($_SERVER['REQUEST_METHOD'] == "POST" and isset($_POST['submitdon'])){
    ...
    {   $amount = "100";
        $insertOneResult = $donordonation->insertOne(
            ['fullname' => $fullname, 'projectname' => $projectname, 'amount' => $amount]
            );
    ...
    else if ($radioVal == "Others" && trim($fullname) != '' && trim($donateamt) != '')
    {
        ...
        $insertOneResult = $donordonation->insertOne(
            ['fullname' => $fullname, 'projectname' => $projectname, 'amount' => $donateamt]
            );
                ...
                <div class="input-group-prepend">
                  <span class="input-group-text">₹</span></div>
                       ...
                       <div class="need d-flex align-items-center
                        ...
                        <button type="submit"  name="submitdon" class="btn trigger">Donate Now</button>
                        </div>
                        </div>
                        </div>
                        </div>
